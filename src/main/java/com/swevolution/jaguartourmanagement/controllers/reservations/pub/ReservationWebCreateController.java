 ...
 */
package com.swevolution.jaguartourmanagement.controllers.reservations.pub;
...
import com.swevolution.jaguartourmanagement.controllers.reservations.*;
import com.swevolution.jaguartourmanagement.controllers.tour.pub.TourView;
...
@Named
@ViewScoped
public class ReservationWebCreateController implements Serializable {
    ...
    public void reset() {
        ...
        reservacion.setTour(tourView.getTour());
