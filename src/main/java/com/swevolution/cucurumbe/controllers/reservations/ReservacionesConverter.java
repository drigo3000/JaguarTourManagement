...
@Named
@RequestScoped
public class ReservacionesConverter implements Converter {

    @EJB
    private ReservationsFacade controller;
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value != null && value instanceof Reservation) {
            return ((Reservation) value).getId().toString();
        }
        return null;
    }
